...
public class GroupSession {
	...
	public boolean bookASession() {
		...
		while(!cinfo.isCustValid(custID)) {
			...
			System.out.println("Enter Valid Customer ID Again (sample input: C001,C002,C003,....C014,C015)");
			custID= read.next().toUpperCase();
			System.out.println("is valid"+cinfo.isCustValid(custID));
		...
		while (checkFlag) {
			...
			if(choice==1) {
				...
				try
				{
					...
					System.out.println("---------------------------------------------------------------");
					System.out.println("FitID\t Fitness\t price	\tDate");
					System.out.println("---------------------------------------------------------------");
					cont = 0;
...
//		System.out.println("enter customer ID");
		...
		//System.out.println("enfroollll"+enrollData);
